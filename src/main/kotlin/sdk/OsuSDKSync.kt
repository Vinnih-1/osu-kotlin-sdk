...
interface OsuSDKSync {
     ...
     */
    fun getBeatmapPacks(type: BeatmapPackType? = BeatmapPackType.STANDARD, cursor: String? = ""): BeatmapPackResponse
     ...
     */
    fun getBeatmapPack(pack: String, legacyOnly: Boolean? = false): BeatmapPack
     ...
     */
    fun getBeatmaps(ids: List<Int>? = listOf()): BeatmapsResponse
     ...
     */
    fun getBeatmapAttributes(beatmapId: Int, mods: List<ModLegacy>, mode: Ruleset): BeatmapDifficultyAttributesResponse
     ...
     */
    fun getBeatmapsetDiscussionPosts(
     ...
     */
    fun getBeatmapsetDiscussionVotes(
        beatmapsetDiscussionId: String? = null,
        limit: Int? = 100,
        page: Int? = null,
    ...
    fun searchBeatmapset(cursorString: String? = null): SearchBeatmapsetResponse

    fun getBeatmapset(beatmapsetId: Int): Beatmapset

    fun getBeatmapsetEvents(): BeatmapsetEventsResponse
     ...
     */
    fun getChangelogBuild(stream: String, build: String): Build
     ...
     */
    fun lookupChangelogBuild(build: String, messageFormats: List<String>? = listOf("html, markdown")): Build
     ...
     */
    fun getFriends(): List<UserRelation>
     ...
     */
    fun getChannelList(): List<ChatChannel>
     ...
     */
    fun getChannel(channelId: Int): GetChannelResponse
     ...
     */
    fun sendMessageChannel(channelId: Int, message: String, isAction: Boolean = false): ChatMessage
     ...
     */
    fun joinChannel(channelId: Int, userId: Int): ChatChannel
     ...
     */
    fun leaveChannel(channelId: Int, userId: Int)
     ...
     */
    fun downloadScore(scoreId: Long, isOldFormat: Boolean? = false): ByteArray
     ...
     */
    fun getScore(mode: Ruleset? = Ruleset.OSU, cursorString: String? = null): ScoreResponse
     ...
     */
    fun getUsers(ids: List<String>, includeVariantStatistics: Boolean? = true): UsersResponse
     ...
     */
    fun getUserKudosu(userId: Int, limit: Int? = 50, offset: String? = "0"): List<KudosuHistory>
     ...
     */
    fun getUserRecentActivity(userId: Int, offset: Int? = 0, limit: Int? = 100): List<Event>
     ...
     */
    fun getOwnData(mode: Ruleset? = Ruleset.OSU): User
     ...
     */
    fun getComment(commentId: Int): CommentBundle
     ...
     */
    fun getForumListing(): List<Forum>
     ...
     */
    fun getForumAndTopics(forumId: Int): ForumAndTopicsResponse
     ...
     */
    fun editTopic(topicId: Int, title: String): ForumTopic
     ...
     */
    fun replyTopic(topicId: Int, body: String): ForumPost
     ...
     */
    fun editPost(postId: Int, body: String): ForumPost
     ...
     */
    fun getKudosuRanking(page: Int? = null): KudosuRankingResponse
     ...
     */
    fun getSpotlights(): SpotlightsRankingResponse
     ...
     */
    fun getWikiPage(locale: String, path: String): WikiPage
}